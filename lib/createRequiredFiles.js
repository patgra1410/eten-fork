...
module.exports = function() {
    ...
    let ranking = require('../data/ranking.json')
    for (let option of ['pilkarzyki', 'kwadraty', 'teampilkarzyki', 'najdluzszyruch', 'najdluzszagrateampilkarzyki', 'najdluzszagrapilkarzyki', 'sumaruchow', 'jajco'])
