...
module.exports = async function(message) {
	...
	if (/https?:\/\/media.discordapp.net\/attachments\/[0-9]+\/[0-9]+\/[A-Za-z\-0-9]+.[A-Za-z]+/g.test(message.content)) {
		const foundMediaLinks = message.content.match(/https?:\/\/media.discordapp.net\/attachments\/[0-9]+\/[0-9]+\/[A-Za-z\-0-9]+.[A-Za-z]+/g)
		for (const mediaLink in foundMediaLinks)
